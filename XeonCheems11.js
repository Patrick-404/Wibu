...
module.exports = XeonBotInc = async (XeonBotInc, m, chatUpdate, store) => {
    ...
    replygcxeon(`Fitur ini untuk pengguna premium, hubungi pemiliknya untuk menjadi pengguna premium`)
}
        //script replier
	...
	if (db.data.settings[botNumber].autobio) {
     ...
     //auto type record
        ...
        if (!m.sender.startsWith(`${antiforeignnumber}`) && db.data.chats[m.chat].antiforeignnum === true){ 
            ...
            XeonBotInc.sendMessage(m.chat, { text: `Maaf teman! Anda akan dikeluarkan karena admin/pemilik grup telah mengaktifkan anti nomor asing saja +${antiforeignnumber} kode negara diperbolehkan untuk bergabung dengan grup` }, {quoted: m})
            await sleep(2000)
